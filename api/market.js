...
const TF = {
  "1m": { granularity: 60, aggregate: null },
  "3m": { granularity: 60, aggregate: 3 },
  "5m": { granularity: 300, aggregate: null },
  "15m": { granularity: 900, aggregate: null },
  "1h": { granularity: 3600, aggregate: null }
};
...
function aggregate(a, minutes) {
  ...
  for (const c of a) {
    ...
    if (!g || g.bucket !== bucket) {
      ...
      g.close = c.close;
      g.volume += c.volume || 0;
      g.complete = g.complete && c.complete !== false;
    }
  }
