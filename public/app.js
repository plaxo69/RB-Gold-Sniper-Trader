...
function analyze(main, m5, m15, h1) {
  return window.RBGoldSniper.analyze(main, m5, m15, h1);
}
...
function renderAnalysis(a) {
  ...
  if(a.type==="WAIT"){const rejected=a.rejectionReasons?.length?` Filtros pendentes: ${a.rejectionReasons.join(" • ")}.`:"";box.innerHTML=`<div class="no-trades">⏳ WAIT — sem convergência Sniper suficiente.${rejected} Última análise: ${a.price.toFixed(2)}</div>`;return;}
